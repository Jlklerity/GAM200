...
std::string AssetManager::AssetPath(const std::string& folder, const std::string& name)
{
...
std::string AssetManager::ShaderPath(const std::string& name)
{
    return AssetPath("shaders", name);
}

std::string AssetManager::ImagePath(const std::string& name)
{
    return AssetPath("images",  name);
}

std::string AssetManager::LoadShaderAsString(const std::string& path)
{
...
GLuint AssetManager::setup_texobj(std::string const& tex_path)
{
